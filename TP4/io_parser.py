...
from models import HopfieldObservables, HopfieldProperties, KohonenObservables, KohonenProperties
import pandas as pd
...
def parse_kohonen_properties(json_values):
    ...
    (countries,input_set) = get_kohonen_dataset(dataset_path)
